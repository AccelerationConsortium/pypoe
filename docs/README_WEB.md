...
JSON payload there; on `DOWN` alerts PyPoe runs a background
OpenRouter investigation, posts the synthesised summary into a
Slack thread, and journals findings via the aggregator. On `RECOVERY`
